...
<div class="row">
  <div class="col-md-3">
    <div class="card text-white bg-primary mb-3">
      ...
      <div class="card-body">
        <h1 class="card-title">{{ $totalRegistrosComparados_Hr }}</h1>
      </div>
    </div>
  </div>
  <div class="col-md-3">
...
<table class="table table-striped" id="my-table">
    ...
    <tbody>
        @foreach ($empleadosSinHr as $empleadossin)
            <tr>
                <td>{{ $empleadossin->empnumber }}</td>
                <td>{{ $empleadossin->name }}</td>
                <td>{{ $empleadossin->puesto }}</td>
            </tr>
        @endforeach
    </tbody>
</table>
